...
class SMCService {
  ...
  struct SMCParamStruct {
    ...
    var dataSize: UInt32 = 0  // 4
    var dataType: UInt32 = 0  // 8
    var dataAttributes: UInt8 = 0  // 12
    var result: UInt8 = 0  // 13
    var status: UInt8 = 0  // 14
    var data8: UInt8 = 0  // 15 (Command)
    var data32: UInt32 = 0  // 16
    var bytes:
      (
